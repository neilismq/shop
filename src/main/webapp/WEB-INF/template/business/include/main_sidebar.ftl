			...
			<div id="promotionPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("business/promotion_plugin.*|business/promotion_plugin/.*|business/.*promotion/.*|business/coupon/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						[@promotion_plugin]
							[#if promotionPlugin]
								<li class="list-group-item[#if .main_template_name?matches("business/promotion_plugin.*|business/promotion_plugin/.*|business/.*promotion/.*")] active[/#if]">
									<a href="${base}/business/promotion_plugin">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("business.mainSidebar.promotionPlugin")}
									</a>
								</li>
							[/#if]
						[/@promotion_plugin]
