...
<head>
	...
	<title>${message("business.freeShippingPromotionPlugin.add")} - Powered By SHOP++</title>
		...
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				$productIds.selectpicker({
					...
					ajax: {
						url: "${base}/business/free_shipping_promotion/product_select",
						type: "GET",
						data: function() {
							return {
								keyword: "{{{q}}}"
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("business.freeShippingPromotionPlugin.add")}</li>
			</ol>
			<form id="freeShippingPromotionForm" class="ajax-form form-horizontal" action="${base}/business/free_shipping_promotion/save" method="post">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<div class="checkbox checkbox-inline">
											...
											<input id="isFreeShipping" name="isFreeShipping" type="checkbox" value="true" checked>
