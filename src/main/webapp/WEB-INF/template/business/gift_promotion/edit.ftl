...
<head>
	...
	<title>${message("business.giftPromotionPlugin.edit")} - Powered By SHOP++</title>
		...
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				$productIds.selectpicker({
					...
					ajax: {
						url: "${base}/business/coupon_promotion/product_select",
						type: "GET",
						data: function() {
							return {
								keyword: "{{{q}}}"
				...
				$giftIds.selectpicker({
					...
					ajax: {
						url: "${base}/business/gift_promotion/gift_select",
						type: "GET",
						data: function() {
							return {
								keyword: "{{{q}}}"
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("business.giftPromotionPlugin.edit")}</li>
			</ol>
			<form id="moneyOffPromotionForm" class="ajax-form form-horizontal" action="${base}/business/gift_promotion/update" method="post">
				<input name="promotionId" type="hidden" value="${promotion.id}">
				<input name="giftAttributeId" type="hidden" value="${giftAttribute.id}">
					...
					<div class="panel-body">
						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<div class="input-group">
											<input id="minPrice" name="minPrice" class="form-control" type="text" value="${giftAttribute.minPrice}" maxlength="16">
											<span class="input-group-addon">-</span>
											<input name="maxPrice" class="form-control" type="text" value="${giftAttribute.maxPrice}" maxlength="16">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<div class="input-group">
											<input id="minQuantity" name="minQuantity" class="form-control" type="text" value="${giftAttribute.minQuantity}" maxlength="9">
											<span class="input-group-addon">-</span>
											<input name="maxQuantity" class="form-control" type="text" value="${giftAttribute.maxQuantity}" maxlength="9">
										</div>
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label">${message("Promotion.products")}:</label>
									<div class="col-xs-9 col-sm-4">
										<select id="productIds" name="productIds" class="form-control" title="${message("business.promotionPlugin.productTitle")}" multiple>
								...
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label item-required">${message("GiftAttribute.gifts")}:</label>
									<div class="col-xs-9 col-sm-4">
										<select id="giftIds" name="giftIds" class="form-control" title="${message("business.giftPromotionPlugin.giftTitle")}" multiple>
											[#list giftAttribute.gifts as gift]
