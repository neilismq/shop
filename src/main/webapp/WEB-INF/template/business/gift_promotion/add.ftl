...
<head>
	...
	<title>${message("business.giftPromotionPlugin.add")} - Powered By SHOP++</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				var $promotionForm = $("#promotionForm");
				...
				$productIds.selectpicker({
					...
					ajax: {
						url: "${base}/business/gift_promotion/product_select",
						type: "GET",
						data: function() {
							return {
								keyword: "{{{q}}}"
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("business.giftPromotionPlugin.add")}</li>
			</ol>
			<form id="promotionForm" class="ajax-form form-horizontal" action="${base}/business/gift_promotion/save" method="post">
						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<select id="giftIds" name="giftIds" class="form-control" title="${message("business.giftPromotionPlugin.giftTitle")}" multiple></select>
									</div>
								</div>
								<div class="form-group">
