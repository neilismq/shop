	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("business.couponPromotionPlugin.edit")}</li>
			</ol>
			<form id="couponPromotionForm" class="ajax-form form-horizontal" action="${base}/business/coupon_promotion/update" method="post">
				<input name="promotionId" type="hidden" value="${promotion.id}">
				<input name="couponAttributeId" type="hidden" value="${couponAttribute.id}">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<div class="input-group">
											<input id="minPrice" name="minPrice" class="form-control" type="text" value="${couponAttribute.minPrice}" maxlength="16">
											<span class="input-group-addon">-</span>
											<input name="maxPrice" class="form-control" type="text" value="${couponAttribute.maxPrice}" maxlength="16">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<div class="input-group">
											<input id="minQuantity" name="minQuantity" class="form-control" type="text" value="${couponAttribute.minQuantity}" maxlength="9">
											<span class="input-group-addon">-</span>
											<input name="maxQuantity" class="form-control" type="text" value="${couponAttribute.maxQuantity}" maxlength="9">
										</div>
									</div>
								</div>
								[#if coupons?has_content]
									<div class="form-group">
										<label class="col-xs-3 col-sm-2 control-label">${message("CouponAttribute.coupons")}:</label>
										<div class="col-xs-9 col-sm-10">
											[#list coupons as coupon]
												<div class="checkbox checkbox-inline">
													<input id="coupon_${coupon.id}" name="couponIds" type="checkbox" value="${coupon.id}"[#if couponAttribute.coupons?seq_contains(coupon)] checked[/#if]>
