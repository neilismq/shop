...
<head>
	...
	<title>${message("business." + promotionPlugin.id + ".list")} - Powered By SHOP++</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("business." + promotionPlugin.id + ".list")}</li>
			</ol>
			<form action="${base}/business/promotion_plugin/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}${promotionPlugin.addUrl}?promotionPluginId=${promotionPlugin.id}" data-redirect-url="${base}/business/promotion_plugin/list?promotionPluginId=${promotionPlugin.id}">
