					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10 permissions">
								...
								<div class="checkbox checkbox-inline">
									<input id="wechatMessageTemplate" name="permissions" type="checkbox" value="admin:wechatMessageTemplate"[#if role.permissions?seq_contains("admin:wechatMessageTemplate")] checked[/#if]>
									<label for="wechatMessageTemplate">${message("admin.role.wechatMessageTemplate")}</label>
								</div>
							</div>
						</div>
						<div class="form-group">
