...
<aside id="mainSidebar" class="main-sidebar">
	...
	<div id="mainSidebarPanelGroup" class="panel-group">
		...
		<div class="panel panel-default">
			[@has_any_permissions_tag permissions = ["admin:member", "admin:memberRank", "admin:memberAttribute", "admin:point", "admin:memberDeposit", "admin:review", "admin:consultation", "admin:messageConfig", "admin:wechatMessageTemplate"]]
				[#if hasPermission]
					<div class="panel-heading">
						<h4 class="panel-title">
							<a href="#memberGroupPanelCollapse" data-toggle="collapse" data-parent="#mainSidebarPanelGroup"[#if .main_template_name?matches("admin/member/.*|admin/member_rank/.*|admin/member_attribute/.*|admin/point/.*|admin/member_deposit/.*|admin/review/.*|admin/consultation/.*|admin/message_config/.*|admin/wechat_message_template/.*")] aria-expanded="true"[/#if]>
				...
				[/#if]
			[/@has_any_permissions_tag]
			<div id="memberGroupPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("admin/member/.*|admin/member_rank/.*|admin/member_attribute/.*|admin/point/.*|admin/member_deposit/.*|admin/review/.*|admin/consultation/.*|admin/message_config/.*|admin/wechat_message_template/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						...
						[@has_permission_tag permission="admin:messageConfig"]
							...
							[/#if]
						[/@has_permission_tag]
						[@has_permission_tag permission="admin:wechatMessageTemplate"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/wechat_message_template/.*")] active[/#if]">
									<a href="${base}/admin/wechat_message_template/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.wechatMessageTemplate")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
		...
		<div class="panel panel-default">
			...
			<div id="distributorGroupPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("admin/distributor/.*|admin/distribution_cash/.*|admin/distribution_commission/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						[@has_permission_tag permission="admin:distributor"]
							[#if hasPermission]
							...
							[/#if]
						[/@has_permission_tag]
						[@has_permission_tag permission="admin:distributionCash"]
							[#if hasPermission]
							...
							[/#if]
						[/@has_permission_tag]
						[@has_permission_tag permission="admin:distributionCommission"]
							[#if hasPermission]
		...
		<div class="panel panel-default">
			...
			<div id="marketingGroupPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("admin/promotion/.*|admin/coupon/.*|admin/seo/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						[@has_permission_tag permission="admin:promotion"]
							[#if hasPermission]
							...
							[/#if]
						[/@has_permission_tag]
						[@has_permission_tag permission="admin:coupon"]
							[#if hasPermission]
		...
		<div class="panel panel-default">
			[@has_any_permissions_tag permissions = ["admin:setting", "admin:area", "admin:paymentMethod", "admin:shippingMethod", "admin:deliveryCorp", "admin:paymentPlugin", "admin:storagePlugin", "admin:loginPlugin", "admin:promotionPlugin", "admin:admin", "admin:role", "admin:auditLog"]]
				[#if hasPermission]
					<div class="panel-heading">
						<h4 class="panel-title">
