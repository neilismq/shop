		...
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				$addDistributionCommissionRate.click(function() {
					...
					if (distributionCommissionRates.length >= 3) {
						$.bootstrapGrowl("${message("admin.setting.maxDistributionCommissionRatesSize")}", {
							type: "warning"
						});
						return false;
					}
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<div id="distributionCommissionRate" style="padding: 0 20px;"></div>
							</div>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<ul class="nav nav-tabs">
							...
							<li>
								<a href="#wechat" data-toggle="tab">${message("admin.setting.wechat")}</a>
							</li>
							<li>
						...
						<div class="tab-content">
							...
							<div id="wechat" class="tab-pane">
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label" for="serviceAccountAppId">${message("Setting.serviceAccountAppId")}:</label>
									<div class="col-xs-9 col-sm-4">
										<input id="serviceAccountAppId" name="serviceAccountAppId" class="form-control" type="text" value="${setting.serviceAccountAppId}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label" for="serviceAccountAppSecret">${message("Setting.serviceAccountAppSecret")}:</label>
									<div class="col-xs-9 col-sm-4">
										<input id="serviceAccountAppSecret" name="serviceAccountAppSecret" class="form-control" type="text" value="${setting.serviceAccountAppSecret}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label" for="miniProgramAppId">${message("Setting.miniProgramAppId")}:</label>
									<div class="col-xs-9 col-sm-4">
										<input id="miniProgramAppId" name="miniProgramAppId" class="form-control" type="text" value="${setting.miniProgramAppId}" maxlength="200">
									</div>
								</div>
							</div>
