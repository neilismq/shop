...
<head>
	...
	<title>${message("admin.plugin.groupBuyingPromotion.setting")} - Powered By SHOP++</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.groupBuyingPromotion.setting")}</li>
			</ol>
			<form id="groupBuyingPromotionForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/group_buying_promotion/update" method="post">
