...
<head>
	...
	<title>${message("admin.plugin.weixinMiniProgramPayment.setting")} - Powered By SHOP++</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				var $weixinMiniProgramPaymentForm = $("#weixinMiniProgramPaymentForm");
				
				// 表单验证
				$weixinMiniProgramPaymentForm.validate({
					rules: {
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.weixinMiniProgramPayment.setting")}</li>
			</ol>
			<form id="weixinMiniProgramPaymentForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/weixin_mini_program_payment/update" method="post">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="appId">${message("admin.plugin.weixinMiniProgramPayment.appId")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="appId" name="appId" class="form-control" type="text" value="${pluginConfig.getAttribute("appId")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="appSecret">${message("admin.plugin.weixinMiniProgramPayment.appSecret")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="appSecret" name="appSecret" class="form-control" type="text" value="${pluginConfig.getAttribute("appSecret")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="mchId">${message("admin.plugin.weixinMiniProgramPayment.mchId")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="mchId" name="mchId" class="form-control" type="text" value="${pluginConfig.getAttribute("mchId")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="apiKey">${message("admin.plugin.weixinMiniProgramPayment.apiKey")}:</label>
							<div class="col-xs-9 col-sm-4">
