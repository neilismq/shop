...
<head>
	...
	<title>${message("admin.plugin.giftPromotion.setting")} - Powered By SHOP++</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				var $giftPromotionForm = $("#giftPromotionForm");
				
				// 表单验证
				$giftPromotionForm.validate({
					rules: {
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.giftPromotion.setting")}</li>
			</ol>
			<form id="giftPromotionForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/gift_promotion/update" method="post">
