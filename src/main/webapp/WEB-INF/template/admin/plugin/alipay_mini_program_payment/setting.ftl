...
<head>
	...
	<title>${message("admin.plugin.alipayMiniProgramPayment.setting")} - Powered By SHOP++</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				var $alipayMiniProgramPaymentForm = $("#alipayMiniProgramPaymentForm");
				
				// 表单验证
				$alipayMiniProgramPaymentForm.validate({
					rules: {
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.alipayMiniProgramPayment.setting")}</li>
			</ol>
			<form id="alipayMiniProgramPaymentForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/alipay_mini_program_payment/update" method="post">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="appId">${message("admin.plugin.alipayMiniProgramPayment.appId")}:</label>
							<div class="col-xs-4 col-sm-4">
								<input id="appId" name="appId" class="form-control" type="text" value="${pluginConfig.getAttribute("appId")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="appPrivateKey">${message("admin.plugin.alipayMiniProgramPayment.appPrivateKey")}:</label>
							<div class="col-xs-9 col-sm-4">
								<textarea id="appPrivateKey" name="appPrivateKey" class="form-control" rows="5">${pluginConfig.getAttribute("appPrivateKey")}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="alipayPublicKey">${message("admin.plugin.alipayMiniProgramPayment.alipayPublicKey")}:</label>
							<div class="col-xs-9 col-sm-4">
