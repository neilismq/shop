...
<head>
	...
	<title>${message("admin.plugin.moneyOffPromotion.setting")} - Powered By SHOP++</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.moneyOffPromotion.setting")}</li>
			</ol>
			<form id="moneyOffPromotionForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/money_off_promotion/update" method="post">
