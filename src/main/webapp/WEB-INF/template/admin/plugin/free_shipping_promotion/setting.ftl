...
<head>
	...
	<title>${message("admin.plugin.freeShippingPromotion.setting")} - Powered By SHOP++</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.freeShippingPromotion.setting")}</li>
			</ol>
			<form id="freeShippingPromotionForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/free_shipping_promotion/update" method="post">
