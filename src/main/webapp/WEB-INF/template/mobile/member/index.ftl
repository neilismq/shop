		...
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				$logout.click(function() {
					...
					if ($.isHtml5Plus()) {
						function logout() {
							window.plus.navigator.removeSessionCookie();
						}

						if (window.plus) {
							logout();
						} else {
							document.addEventListener("plusready", logout);
						}
						return false;
					}
				});
...
<body class="member">
	...
	<footer class="footer-default html5plus-hidden" data-spy="scrollToFixed" data-bottom="0">
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-3">
					<a href="${base}/">
