		...
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				$closeStoreProductCategory.click(function() {
					$storeProductCategory.velocity("transition.slideRightBigOut", 400).parent().velocity("fadeOut");
				});
				...
				$showStoreProductCategory.click(function() {
					$storeProductCategory.velocity("transition.slideRightBigIn", 400).parent().velocity("fadeIn");
				});
