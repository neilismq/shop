...
<body>
	...
	<div class="body">
		...
		<div class="bodyRight">
			...
			<table>
				...
				<tr>
					<td>
						<span title="<%=webXmlFile.getPath()%>"><%=StringUtils.abbreviateMiddle(webXmlFile.getPath(), "...", 50)%></span>
					</td>
					<td>
						可写
					</td>
				...
				<tr>
					<td>
						<span title="<%=shopxxXmlFile.getPath()%>"><%=StringUtils.abbreviateMiddle(shopxxXmlFile.getPath(), "...", 50)%></span>
					</td>
					<td>
						可写
					</td>
				...
				<tr>
					<td>
						<span title="<%=shopxxPropertiesFile.getPath()%>"><%=StringUtils.abbreviateMiddle(shopxxPropertiesFile.getPath(), "...", 50)%></span>
					</td>
					<td>
						可写
					</td>
	...
	<div class="footer">
		<p class="copyright">Copyright © 2008-2019 shopxx.net All Rights Reserved.</p>
	</div>
</body>
</html>