 ...
 * FileId: BA0NcN8iscHwiEWHF+HevzlOmYyYMGCz
 */
package net.shopxx;
...
public class Setting implements Serializable {
     ...
     */
    @Length(max = 200)
    private String serviceAccountAppSecret;
     ...
     * 设置默认店铺logo
     *
     * @param defaultStoreLogo 默认店铺logo
     */
     ...
     * 设置允许注册类型
     *
     * @param allowedRegisterTypes 允许注册类型
     */
     ...
     * 设置最大登录失败尝试次数
     *
     * @param maxFailedLoginAttempts 最大登录失败尝试次数
     */
     ...
     * @return 服务号AppId
     */
    public String getServiceAccountAppId() {
     ...
     * 设置服务号AppId
     *
     * @param serviceAccountAppId 服务号AppId
     */
    public void setServiceAccountAppId(String serviceAccountAppId) {
        this.serviceAccountAppId = serviceAccountAppId;
    }
     ...
     * @return 服务号AppSecret
     */
    public String getServiceAccountAppSecret() {
        return serviceAccountAppSecret;
    }

    /**
     * 设置服务号AppSecret
     *
     * @param serviceAccountAppSecret 服务号AppSecret
     */
    public void setServiceAccountAppSecret(String serviceAccountAppSecret) {
        this.serviceAccountAppSecret = serviceAccountAppSecret;
    }
     ...
     * 设置自动收货时间
     *
     * @param automaticReceiveTime 自动收货时间
     */
     ...
     * 设置会员最小提现金额
     *
     * @param memberMinimumCashAmount 会员最小提现金额
     */
     ...
     * 设置商家最小提现金额
     *
     * @param businessMinimumCashAmount 商家最小提现金额
     */
     ...
     * 设置分销佣金比例
     *
     * @param distributionCommissionRates 分销佣金比例
     */
     ...
     * 设置快递100公司编号
     *
     * @param kuaidi100Customer 快递100公司编号
     */
