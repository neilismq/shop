 ...
 * FileId: CofKP8HLKdbLk1ytnPfPz75YLO9/jxwz
 */
...
public class CacheServiceImpl implements CacheService {
	...
	@CacheEvict(value = { "setting", "templateConfig", "pluginConfig", "messageConfig", "indexPage", "storeIndexPage", "articleListPage", "articleDetailPage", "productListPage", "productDetailPage", "brandListPage", "brandDetailPage", "productCategoryPage", "promotionDetailPage", "friendLinkPage",
			...
			"productCategory", "productTag", "storeProductCategory", "storeProductTag", "storeAdImage", "productFavorite", "storeFavorite", "consultation", "review", "promotion", "transitSteps", "authorization", "participants" }, allEntries = true)
	public void clear() {
