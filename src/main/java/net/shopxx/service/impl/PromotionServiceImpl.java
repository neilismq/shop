 ...
 * FileId: ZEjnueI4ask22o3+8DgQ1TQ+BOD2LNBz
 */
...
public class PromotionServiceImpl extends BaseServiceImpl<Promotion, Long> implements PromotionService {
	...
	@Override
	@Transactional(readOnly = true)
	public boolean exists(String promotionPluginId, Product product, Collection<Promotion> excludes, Date beginDate, Date endDate) {
		return promotionDao.exists(promotionPluginId, product, excludes, beginDate, endDate, null, false);
	}
	...
	public void modify(Promotion promotion, PromotionDefaultAttribute promotionDefaultAttribute) {
		...
		copyProperties(promotion, pPromotion, "id", "promotionPluginId", "store", "productCategories");
