 ...
 * FileId: 5+0wWyfv6K6rGIpkahkDRK0HJVqaLOVJ
 */
...
public class PluginServiceImpl implements PluginService {
	...
	@Override
	public LoginPlugin getSupportWechatMessageLoginPlugin() {
		return (LoginPlugin) CollectionUtils.find(getLoginPlugins(), new Predicate() {
			@Override
			public boolean evaluate(Object object) {
				LoginPlugin loginPlugin = (LoginPlugin) object;
				return loginPlugin.supportWechatMessage();
			}
		});
	}
