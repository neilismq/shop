 ...
 * FileId: Sk3HiMAdUqMxm0JZFkgRUvefSDbhvYYr
 */
...
public interface OrderService extends BaseService<Order, Long> {
	 ...
	 * @return 订单是否存在
	 */
	boolean exists(GroupBuying groupBuying, Member member, List<Order.Status> statuses);
	 ...
	 * @param order
	 *            订单
	 * @param subtractParticipants
	 *            减少参团人数
	 */
	void cancel(Order order, boolean subtractParticipants);
