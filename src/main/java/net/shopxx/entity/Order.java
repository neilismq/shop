 ...
 * FileId: ADE2l/AIwZZykP6j38rZ1MU2vuilfLNh
 */
...
public class Order extends BaseEntity<Long> {
	 ...
	 */
	@Converter
	public static class PromotionNameConverter extends BaseAttributeConverter<ArrayList<String>> {
	}
