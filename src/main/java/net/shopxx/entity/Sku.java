 ...
 * FileId: Q/oYrH8i5l3nmpGWpkD5+GcYnCoX39Bl
 */
...
import net.shopxx.plugin.GiftPromotionPlugin.GiftAttribute;
...
public class Sku extends BaseEntity<Long> {
	 ...
	 */
	@Transient
	public BigDecimal getPlatformCommission(net.shopxx.entity.Store.Type type) {
	...
	public void preRemove() {
		...
		Set<GiftAttribute> giftAttributes = getGiftAttributes();
		if (CollectionUtils.isNotEmpty(giftAttributes)) {
			for (GiftAttribute giftAttribute : giftAttributes) {
				Set<Sku> gifts = giftAttribute.getGifts();
				gifts.remove(this);
			}
		}
	}
	 ...
	 */
	@Converter
	public static class SpecificationValueConverter extends BaseAttributeConverter<ArrayList<SpecificationValue>> {
	}
