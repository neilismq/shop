 ...
 * FileId: QEbSyBfujNiEvE84qSRu0dhzHU7+M8/U
 */
...
public class SocialUserLoginController extends BaseController {
	 ...
	 */
	@RequestMapping
	public String index(String loginPluginId, String redirectUrl, HttpServletRequest request, HttpServletResponse response) {
