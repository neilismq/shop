 ...
 * FileId: mE06gAodjtWqVa+YLPEb2ZZ2fbzT5hEe
 */
...
public class CouponPromotionController extends BaseController {
	 ...
	 */
	@PostMapping("/save")
	public ResponseEntity<?> save(@ModelAttribute("promotionForm") Promotion promotionForm, @ModelAttribute("couponAttributeForm") CouponPromotionPlugin.CouponAttribute couponAttributeForm, Long[] productIds, Long[] couponIds, Long[] memberRankIds, @CurrentStore Store currentStore) {
	...
	public ResponseEntity<?> update(@ModelAttribute("promotionForm") Promotion promotionForm, @ModelAttribute(binding = false) Promotion promotion, @ModelAttribute("couponAttributeForm") CouponPromotionPlugin.CouponAttribute couponAttributeForm,
			@ModelAttribute(binding = false) CouponPromotionPlugin.CouponAttribute couponAttribute, Long[] productIds, Long[] couponIds, Long[] memberRankIds) {
		if (promotion == null) {
			return Results.UNPROCESSABLE_ENTITY;
		}
