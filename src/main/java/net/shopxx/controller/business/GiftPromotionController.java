 ...
 * FileId: KNxtua80z07dE2B9Cr9sikzQXA3ULKHY
 */
...
public class GiftPromotionController extends BaseController {
	 ...
	 */
	@PostMapping("/save")
	public ResponseEntity<?> save(@ModelAttribute("promotionForm") Promotion promotionForm, @ModelAttribute("giftAttributeForm") GiftPromotionPlugin.GiftAttribute giftAttributeForm, Long[] productIds, Long[] giftIds, Long[] memberRankIds, @CurrentStore Store currentStore) {
	...
	public ResponseEntity<?> update(@ModelAttribute("promotionForm") Promotion promotionForm, @ModelAttribute(binding = false) Promotion promotion, @ModelAttribute("giftAttributeForm") GiftPromotionPlugin.GiftAttribute giftAttributeForm,
			@ModelAttribute(binding = false) GiftPromotionPlugin.GiftAttribute giftAttribute, Long[] productIds, Long[] giftIds, Long[] memberRankIds) {
		if (promotion == null) {
			return Results.UNPROCESSABLE_ENTITY;
		}
