 ...
 * FileId: SxeYqnJqEkn9pWtBT39Y3zsr78bDSIBv
 */
...
public class ProductController extends BaseController {
	...
	public String list(Product.Type type, Long productCategoryId, Long brandId, Long productTagId, Boolean isActive, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isOutOfStock, Boolean isStockAlert, Pageable pageable, ModelMap model) {
		...
		model.addAttribute("page", productService.findPage(type, null, null, productCategory, null, brand, null, productTag, null, null, null, null, null, isMarketable, isList, isTop, isActive, isOutOfStock, isStockAlert, null, null, pageable));
