 ...
 * FileId: DBVjRO5KoVrOo2MIvJK3OyeeImBoCREL
 */
...
public class WeixinH5PaymentPlugin extends PaymentPlugin {
	...
	public boolean supports(HttpServletRequest request) {
		...
		return device.isMobile() && !StringUtils.containsIgnoreCase(userAgent, "micromessenger") && !(StringUtils.containsIgnoreCase(userAgent, "AlipayClient") && StringUtils.containsIgnoreCase(userAgent, "miniprogram"));
	}
