 ...
 * FileId: kysLvvtgDUD/SFydPlPC7R2/xDHm16Et
 */
...
public class WeixinPublicPaymentPlugin extends PaymentPlugin {
	...
	public boolean supports(HttpServletRequest request) {
		...
		return matcher.find() && Integer.valueOf(matcher.group("majorVersion")) >= 5 && !StringUtils.equalsIgnoreCase(weixinMiniProgarm, "true");
	}
