 ...
 * FileId: NVb2FrOsj3AW83GBO5DoTb2SXthJu8f0
 */
...
public class PaypalPaymentPlugin extends PaymentPlugin {
	 ...
	 * 通知验证请求URL
	 */
	private static final String NOTIFY_VALIDATE_REQUEST_URL = "https://ipnpb.paypal.com/cgi-bin/webscr";
	...
	public boolean isPaySuccess(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String paymentDescription, String extra, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (StringUtils.equals(request.getParameter("business"), getAttribute("partner")) && StringUtils.equals(request.getParameter("mc_currency"), getAttribute("currency")) && StringUtils.equals(request.getParameter("payment_status"), "Completed")
			...
			return StringUtils.equals(result, "VERIFIED");
		}
		return false;
	}
