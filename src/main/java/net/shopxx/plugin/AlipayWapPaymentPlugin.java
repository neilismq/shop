 ...
 * FileId: mXLJw7z5Ze6gkJdBUNcSPFRp8/FwgnLw
 */
...
public class AlipayWapPaymentPlugin extends PaymentPlugin {
	...
	public boolean supports(HttpServletRequest request) {
		...
		return device != null && (device.isMobile() || device.isTablet()) && !StringUtils.equalsIgnoreCase(weixinMiniProgarm, "true") && !(StringUtils.containsIgnoreCase(userAgent, "AlipayClient") && StringUtils.containsIgnoreCase(userAgent, "miniprogram"));
	}
